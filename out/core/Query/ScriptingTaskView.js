...
exports.createScriptingTaskView = createScriptingTaskView;
 ...
 */
function createScriptingTaskView(task) {
    return {
        ...
        due: new TasksDate_1.TasksDate(task.dueDate),
        scheduled: new TasksDate_1.TasksDate(task.scheduledDate),
        start: new TasksDate_1.TasksDate(task.startDate),
        done: new TasksDate_1.TasksDate(task.doneDate),
        created: new TasksDate_1.TasksDate(task.createdDate),
        cancelled: new TasksDate_1.TasksDate(task.cancelledDate),
        happens: new TasksDate_1.TasksDate(task.happens),
        isDone: task.isDone,
...
//# sourceMappingURL=ScriptingTaskView.js.map