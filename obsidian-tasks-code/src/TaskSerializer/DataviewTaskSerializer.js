...
exports.DataviewTaskSerializer = exports.DATAVIEW_SYMBOLS = void 0;
const TaskLayoutOptions_1 = require("../Layout/TaskLayoutOptions");
const PriorityTools_1 = require("../lib/PriorityTools");
const DefaultTaskSerializer_1 = require("./DefaultTaskSerializer");
/**
...
exports.DATAVIEW_SYMBOLS = {
    ...
    TaskFormatRegularExpressions: {
        ...
        dependsOnRegex: toInlineFieldRegex(new RegExp('dependsOn:: *(' + DefaultTaskSerializer_1.taskIdSequenceRegex.source + ')')),
        idRegex: toInlineFieldRegex(new RegExp('id:: *(' + DefaultTaskSerializer_1.taskIdRegex.source + ')')),
    },
};
/**
 ...
 *   [Dataview]{@link https://github.com/blacksmithgu/obsidian-dataview}
 */
class DataviewTaskSerializer extends DefaultTaskSerializer_1.DefaultTaskSerializer {
    constructor() {
        super(exports.DATAVIEW_SYMBOLS);
    }
    parsePriority(p) {
        return PriorityTools_1.PriorityTools.priorityValue(p);
    }
    componentToString(task, shortMode, component) {
        ...
        const notInlineFieldComponents = [
            TaskLayoutOptions_1.TaskLayoutComponent.BlockLink,
            TaskLayoutOptions_1.TaskLayoutComponent.Description,
        ];
...
exports.DataviewTaskSerializer = DataviewTaskSerializer;
//# sourceMappingURL=DataviewTaskSerializer.js.map