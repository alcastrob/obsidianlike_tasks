...
exports.newLivePreviewExtension = void 0;
...
const DismissibleNotices_1 = require("../Config/DismissibleNotices");
...
const newLivePreviewExtension = (plugin) => {
    return view_1.ViewPlugin.fromClass(class extends LivePreviewExtension {
        constructor(view) {
            super(view, plugin);
        }
    });
};
exports.newLivePreviewExtension = newLivePreviewExtension;
/**
        ...
        this.handleClickEvent = (event) => {
            ...
            if (ancestor) {
                if (ancestor.matches('div.callout-content')) {
                    ...
                    const msg = i18n_1.i18n.t('notices.live-preview-callout-warning.line1') +
                        '\n\n' +
                        i18n_1.i18n.t('notices.live-preview-callout-warning.line2') +
                        '\n\n' +
                        i18n_1.i18n.t('notices.live-preview-callout-warning.line3') +
                        '\n\n' +
                        i18n_1.i18n.t('notices.live-preview-callout-warning.line4') +
                        '\n' +
                        i18n_1.i18n.t('notices.live-preview-callout-warning.line5') +
                        '\n' +
                        i18n_1.i18n.t('notices.live-preview-callout-warning.line6', { commandName: Commands_1.ToggleTaskDoneCommandName });
                    (0, DismissibleNotices_1.showDismissibleNotice)(dontShowAgainKey, msg, this.plugin);
                }
                return false;
            }
            ...
            const task = Task_1.Task.fromLine({
                ...
                taskLocation: TaskLocation_1.TaskLocation.fromUnknownPosition(new TasksFile_1.TasksFile('')),
                fallbackDate: null,
            });
...
//# sourceMappingURL=LivePreviewExtension.js.map