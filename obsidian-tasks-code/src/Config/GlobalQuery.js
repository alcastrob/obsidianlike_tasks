...
class GlobalQuery {
     ...
     */
    constructor(source = GlobalQuery.empty) {
        this._source = source;
    }
    /**
     ...
     * @param tasksFile
     */
    query(tasksFile = undefined) {
        const query = new Query_1.Query(this._source, tasksFile);
...
GlobalQuery.empty = '';
//# sourceMappingURL=GlobalQuery.js.map