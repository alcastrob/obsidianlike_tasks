...
exports.PresetsSettingsUI = void 0;
const obsidian_1 = require("obsidian");
const PresetsSettingsService_1 = require("../Query/Presets/PresetsSettingsService");
...
class PresetsSettingsUI {
    ...
    constructor(plugin, events) {
        this.presetsSettingsService = new PresetsSettingsService_1.PresetsSettingsService();
     ...
     */
    renderPresetsSettings(containerEl) {
     ...
     */
    renderPresetItem(presetsContainer, settings, key, value, refreshView) {
        const wrapper = presetsContainer.createDiv({ cls: 'tasks-presets-wrapper' });
        const setting = new obsidian_1.Setting(wrapper);
     ...
     */
    setupDragAndDrop(wrapper, key, settings, refreshView) {
        // Drag start
     ...
     */
    getTargetIndex(targetKey, position) {
        const settings = (0, Settings_1.getSettings)();
     ...
     */
    calculateDropPosition(wrapper, e) {
        const rect = wrapper.getBoundingClientRect();
    ...
    clearDropIndicators() {
        ...
        containers.forEach((container) => {
            this.clearDropIndicator(container);
        });
    }
    /**
     ...
     */
    setupAutoResizingTextarea(textArea) {
        const resize = () => {
            // Reset height first.
     ...
     */
    createAddNewPresetButton(containerEl, settings, refreshView) {
        new obsidian_1.Setting(containerEl).addButton((btn) => {
            btn.setButtonText(i18n_1.i18n.t('settings.presets.buttons.addNewPreset'))
                .setCta()
                .onClick(async () => {
...
exports.PresetsSettingsUI = PresetsSettingsUI;
//# sourceMappingURL=PresetsSettingsUI.js.map