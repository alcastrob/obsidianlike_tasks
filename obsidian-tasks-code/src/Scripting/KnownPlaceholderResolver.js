...
exports.resolveKnownPlaceholder = resolveKnownPlaceholder;
/**
 ...
 */
function resolveKnownPlaceholder(reconstructed, queryContext) {
...
function singleStringArgumentRegex(functionName) {
...
function getSingleStringArgument(expression, regex) {
    const match = new RegExp(regex).exec(expression);
    return match?.[2] ?? null;
}
//# sourceMappingURL=KnownPlaceholderResolver.js.map