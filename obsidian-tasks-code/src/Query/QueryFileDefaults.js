...
exports.QueryFileDefaults = void 0;
const Query_1 = require("./Query");
// Enum for handler types
var Handler;
(function (Handler) {
    Handler["Instruction"] = "instruction";
    Handler["ShowAndHide"] = "showAndHide";
    Handler["AddValue"] = "addValue";
})(Handler || (Handler = {}));
...
class QueryFileDefaults {
    ...
    generateInstruction(queryFile, prop) {
    ...
    query(queryFile) {
        return new Query_1.Query(this.source(queryFile), queryFile);
    }
    allPropertyNames() {
...
exports.QueryFileDefaults = QueryFileDefaults;
//# sourceMappingURL=QueryFileDefaults.js.map