...
exports.GroupDisplayHeadingSelector = void 0;
const GroupDisplayHeading_1 = require("./GroupDisplayHeading");
/*
 ...
 */
class GroupDisplayHeadingSelector {
    ...
    getHeadingsForTaskGroup(groupNames) {
        ...
        for (let level = 0; level < groupNames.length; level++) {
            ...
            if (group != this.lastHeadingAtLevel[level]) {
                headingsForGroup.push(new GroupDisplayHeading_1.GroupDisplayHeading(level, group, this.groupers[level].property));
...
exports.GroupDisplayHeadingSelector = GroupDisplayHeadingSelector;
//# sourceMappingURL=GroupDisplayHeadingSelector.js.map