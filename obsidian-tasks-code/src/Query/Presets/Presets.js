...
exports.unknownPresetErrorMessage = unknownPresetErrorMessage;
...
function summariseInstruction(instructions) {
...
function unknownPresetErrorMessage(presentName, presets) {
