...
exports.labelContentWithAccessKey = labelContentWithAccessKey;
...
function labelContentWithAccessKey(labelText, accessKey) {
    if (accessKey === null) {
        return (0, StringHelpers_1.capitalizeFirstLetter)(labelText);
    }
    const accessKeyIndex = labelText.toLowerCase().indexOf(accessKey.toLowerCase());
    if (accessKeyIndex === -1) {
        return `${(0, StringHelpers_1.capitalizeFirstLetter)(labelText)} (<span class="accesskey">${accessKey.toLowerCase()}</span>)`;
    }
    ...
    labelContent = (0, StringHelpers_1.capitalizeFirstLetter)(labelContent);
    return labelContent;
}
//# sourceMappingURL=EditTaskHelpers.js.map