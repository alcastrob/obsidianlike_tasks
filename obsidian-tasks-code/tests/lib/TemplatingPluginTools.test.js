...
const TemplatingPluginTools_1 = require("../../src/lib/TemplatingPluginTools");
const ApprovalTestHelpers_1 = require("../TestingTools/ApprovalTestHelpers");
describe('TemplatingPluginTools', () => {
    const checker = new TemplatingPluginTools_1.TemplatingPluginTools();
    ...
    ])('should reject date search containing unexpanded template text for instruction "%s"', async (instruction) => {
    ...
    it('date templating error sample for docs', () => {
        ...
        (0, ApprovalTestHelpers_1.verifyWithFileExtension)(message, 'text');
    });
});
//# sourceMappingURL=TemplatingPluginTools.test.js.map