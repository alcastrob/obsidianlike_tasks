...
function testRootAndChildren(root, children) {
    expect(root.parent).toEqual(null);
    testChildren(root, children);
}
function testChildren(parent, childList) {
 ...
 */
function printHierarchy(listItem, depth) {
...
describe('cache', () => {
    it('should read one task', () => {
        const tasks = (0, SimulatedFile_1.readTasksFromSimulatedFile)('one_task');
        expect(tasks.length).toEqual(1);
        expect(tasks[0].description).toEqual('#task the only task here');
    });
    it('should read two sibling tasks', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_2siblings');
    ...
    it('should read numbered list items with dot', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('numbered_list_items_standard');
        expect(data.fileContents).toMatchInlineSnapshot(`
    ...
    it('should read numbered list items with closing parenthesis', () => {
        ...
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('numbered_list_items_with_paren');
        expect(data.fileContents).toMatchInlineSnapshot(`
    ...
    it('visualise how Tasks handles sample tasks in issue #3481', () => {
        ...
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('numbered_tasks_issue_3481');
        expect(data.fileContents).toMatchInlineSnapshot(`
    ...
    it('should read one parent and one child task', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent1child');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent
                - [ ] #task child
            "
    ...
    it('should read one parent and two children task', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent
                - [ ] #task child 1
                - [ ] #task child 2
    ...
    it('should read one parent, two children and one grandchild', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children1grandchild');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent task
                - [ ] #task child task 1
                - [ ] #task child task 2
    ...
    it('should read one parent, two children and two grandchildren', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children2grandchildren');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent task
                - [ ] #task child task 1
                    - [ ] #task grandchild 1
    ...
    it('should read one parent, two children, two grandchildren and one sibling', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children2grandchildren1sibling');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent task
                - [ ] #task child task 1
                    - [ ] #task grandchild 1
    ...
    it('should read one parent, 2 children and a sibling', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children1sibling');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent
                - [ ] #task child 1
                - [ ] #task child 2
    ...
    it('should read sibling separated by empty line', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent1child1sibling_emptystring');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] #task parent task
                - [ ] #task child task 1
    ...
    it('should read new root task after header', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent1child1newroot_after_header');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "# first header
    ...
    it('should read root on non-starting line', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_1parent2children2grandchildren1sibling_start_with_heading');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "# Test heading
    ...
    it('should read task and listItem siblings', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_listitem_task_siblings');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- list item
            - [ ] task
            "
    ...
    it('should read child task and parent listItem', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_listitem_task');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- parent list item
                - [ ] child task
            "
    ...
    it('should read grandchild task under parent and child listItem', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_listitem_listitem_task');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- parent list item
                - child list item
                    - [ ] grandchild task
    ...
    it('should read 2 roots with grandchild task under parent and child listItem', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_2roots_listitem_listitem_task');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- parent list item 1
                - child list item 1
                    - [ ] grandchild task 1
    ...
    it('should read parent task and child listItem', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_task_listitem');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] parent task
                - child list item
            "
    ...
    it('should read parent task, child listItem and grandchild task', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_task_listitem_task');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] parent task
                - child list item
                    - [ ] grandchild task
    ...
    it('should read parent task, two child listItems and 3 grandchild tasks', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_task_2listitem_3task');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] parent task
                - child list item 1
                    - [ ] grandchild task 1
    ...
    it('should read parent task with mixed children', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_task_mixed_children');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] parent task
                - [ ] child task 1
                - child list item 1
    ...
    it('should read parent task and child list item with mixed children', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_task_listitem_mixed_grandchildren');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "- [ ] parent task
                - child list item
    ...
    it('should read non task check box when global filter is enabled', () => {
        ...
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('inheritance_non_task_child');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "-  [ ] #task task parent
                - [ ] #task task child
                - [ ] non-task child
    ...
    it('callout', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('callout');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "# callout
    ...
    it('callout_custom', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('callout_custom');
        expect(data.fileContents).toMatchInlineSnapshot(`
            "# callout_custom
    ...
    it('callout_labelled', () => {
        ...
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('callout_labelled');
        // end-snippet
        expect(data.fileContents).toMatchInlineSnapshot(`
            "# callout_labelled
    ...
    it('callouts_nested_issue_2890_unlabelled', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('callouts_nested_issue_2890_unlabelled');
        expect(data.fileContents).toMatchInlineSnapshot(`
            " > [!Calendar]+
             >> [!Check]+
             >>> [!Attention]+
    ...
    it('callouts_nested_issue_2890_labelled', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('callouts_nested_issue_2890_labelled');
        expect(data.fileContents).toMatchInlineSnapshot(`
            " > [!Calendar]+ MONTH
             >> [!Check]+ GROUP
...
describe('accessing links in file', function () {
    describe('explore accessing links in file "links_everywhere.md"', () => {
        const { data, tasks } = (0, SimulatedFile_1.getMockDataAndReadTasks)('links_everywhere');
        expect(tasks.length).toEqual(1);
        const task = tasks[0];
        const cachedMetadata = task.file.cachedMetadata;
        // Usability note:
...
describe('all mock files', () => {
    it.each(AllCacheSampleData_1.AllMockDataNames)('should create valid TasksFile for all mock files: "%s"', (testDataName) => {
    ...
    it.each((0, MockDataHelpers_1.listPathAndData)(AllCacheSampleData_1.AllMockDataNames))('should be able to read tasks from all mock files: "%s"', (path, testDataName) => {
