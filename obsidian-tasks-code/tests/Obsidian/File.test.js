...
const File_1 = require("../../src/Obsidian/File");
/**
 ...
 */
function testFindLineNumberOfTaskToToggle(jsonFileName, taskLineToToggle, expectedLineNumber, actualIncorrectLineFound) {
    // Arrange
    const data = (0, fs_1.readFileSync)('tests/__test_data__/MockDataForTogglingTasks/' + jsonFileName, 'utf-8');
    ...
    const result = (0, File_1.findLineNumberOfTaskToToggle)(originalTask, fileLines, listItemsCache, captureError.bind(errorString));
    // Assert
    ...
    (0, JestApprovals_1.verify)(descriptionOfOutcome);
