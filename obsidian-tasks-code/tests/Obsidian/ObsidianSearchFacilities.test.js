...
function simpleSearchShouldNotMatch(searchTerm, phrase) {
    const fn = (0, obsidian_1.prepareSimpleSearch)(searchTerm);
    const matches = fn(phrase);
    expect(matches).toBeNull();
}
function simpleSearchResultAsJSON(searchTerm, phrase) {
    const fn = (0, obsidian_1.prepareSimpleSearch)(searchTerm);
    const matches = fn(phrase);
...
//# sourceMappingURL=ObsidianSearchFacilities.test.js.map