...
describe('TasksFile', () => {
    it('should provide access to path', () => {
        ...
        const file = (0, TasksFileHelpers_1.createTestTasksFile)(path);
    ...
    it('should provide access to path without extension', () => {
        ...
        expect((0, TasksFileHelpers_1.createTestTasksFile)('/root/folder.mds/file.md').pathWithoutExtension).toStrictEqual('/root/folder.mds/file');
    });
    it('should provide access to the root', () => {
        expect((0, TasksFileHelpers_1.createTestTasksFile)('').root).toStrictEqual('/');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('outside/inside/A.md').root).toStrictEqual('outside/');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('a_b/_c_d_/B.md').root).toStrictEqual('a_b/');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('/root/SeArch_Text/search_text.md').root).toStrictEqual('root/');
    });
    it('should provide access to the folder', () => {
        expect((0, TasksFileHelpers_1.createTestTasksFile)('').folder).toStrictEqual('/');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('outside/inside/file.md').folder).toStrictEqual('outside/inside/');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('a_b/_c_d_/file.md').folder).toStrictEqual('a_b/_c_d_/');
    });
    it('should provide access to the filename', () => {
        expect((0, TasksFileHelpers_1.createTestTasksFile)('').filename).toEqual('');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('file in root.md').filename).toEqual('file in root.md');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('directory name/file in sub-directory.md').filename).toEqual('file in sub-directory.md');
    });
    it('should provide access to the filename without extension', () => {
        expect((0, TasksFileHelpers_1.createTestTasksFile)('').filenameWithoutExtension).toEqual('');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('file in root.md').filenameWithoutExtension).toEqual('file in root');
        expect((0, TasksFileHelpers_1.createTestTasksFile)('directory name/file in sub-directory.md').filenameWithoutExtension).toEqual('file in sub-directory');
        // Check it only replaces the last .md
        expect((0, TasksFileHelpers_1.createTestTasksFile)('1.md.only-replace.2.md').filenameWithoutExtension).toEqual('1.md.only-replace.2');
        // Check it escapes the '.' in the file extension
        expect((0, TasksFileHelpers_1.createTestTasksFile)('1.md.only-replace.2,md').filenameWithoutExtension).toEqual('1.md.only-replace.2,md');
    });
});
describe('TasksFile - raw frontmatter - identicalTo', () => {
    function expectRawFrontmatterToBeIdentical(case1, case2, expectedToBeIdentical) {
        const file1 = (0, MockDataHelpers_1.getTasksFileFromMockData)(case1);
        const file2 = (0, MockDataHelpers_1.getTasksFileFromMockData)(case2);
    ...
    it('should recognise identical frontmatter - simple empty tags list', () => {
        expectRawFrontmatterToBeIdentical('yaml_tags_is_empty_list', 'yaml_tags_had_value_then_was_emptied_by_obsidian', true);
    });
...
describe('TasksFile - reading frontmatter', () => {
    it('should read file if not given CachedMetadata', () => {
        const tasksFile = (0, TasksFileHelpers_1.createTestTasksFile)('some path.md', {});
    ...
    it('should read file with no yaml metadata', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('no_yaml');
        expect(tasksFile.cachedMetadata.frontmatter).toBeUndefined();
        expect(tasksFile.frontmatter).toEqual({ tags: [] });
        expect(tasksFile.frontmatter.tags).toEqual([]);
    });
    it('should read file with empty yaml metadata', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('empty_yaml');
        expect(tasksFile.cachedMetadata.frontmatter).toBeUndefined();
        expect(tasksFile.frontmatter).toEqual({ tags: [] });
        expect(tasksFile.frontmatter.tags).toEqual([]);
    });
    it('should provide an independent copy of frontmatter', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_has_multiple_values');
    ...
    it('should detect whether file is a kanban plugin board', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('example_kanban');
    ...
    it('should read file with custom number property', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_custom_number_property');
        expect(tasksFile.frontmatter?.custom_number_prop).toEqual(42);
    });
    it('should read JSON frontmatter', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('jason_properties');
    ...
    it('should read yaml_complex_example', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_complex_example');
        // Obsidian 1.9.x change in behaviour: See #3482
        // The tags line in frontmatter is:
        //      TAG:
        //          - value1
        ...
        //      []
        (0, JestApprovals_1.verifyAsJson)(tasksFile.frontmatter);
    });
    it('should read yaml_complex_example_standardised', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_complex_example_standardised');
        (0, JestApprovals_1.verifyAsJson)(tasksFile.frontmatter);
    });
    it('should read yaml_all_property_types_empty', () => {
        // See https://help.obsidian.md/Editing+and+formatting/Properties#Property+types
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_all_property_types_empty');
        (0, JestApprovals_1.verifyAsJson)(tasksFile.frontmatter);
    });
    it('should read yaml_all_property_types_populated', () => {
        ...
        (0, JestApprovals_1.verifyAsJson)(frontmatter);
        const propertyValueTypes = Object.keys(frontmatter).map((key) => `${key} => ${(0, ScriptingTestHelpers_1.determineExpressionType)(frontmatter[key])} = ${(0, ScriptingTestHelpers_1.formatToRepresentType)(frontmatter[key])}`);
...
describe('TasksFile - accessing links', () => {
    it('should access all links in the file - both properties and body', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('links_everywhere');
    ...
    it('should access all links in the file body', () => {
        ...
        {
            const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('link_in_yaml');
    ...
    it('should save destinationPath when LinksResolver is supplied', () => {
        LinkResolver_1.LinkResolver.getInstance().setGetFirstLinkpathDestFn((_rawLink, _sourcePath) => 'Hello World.md');
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('link_in_yaml');
        expect(tasksFile.outlinksInProperties[0].originalMarkdown).toEqual('[[yaml_tags_is_empty]]');
...
describe('TasksFile - reading tags', () => {
    it('should read a tag from body and the frontmatter', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_with_one_value_on_new_line');
    ...
    it('should return empty tag list if frontmatter not supplied', () => {
        ...
        const tasksFile = (0, TasksFileHelpers_1.createTestTasksFile)('somewhere.md');
        expect(tasksFile.tags).toEqual([]);
        expect(tasksFile.frontmatter.tags).toEqual([]);
    });
    it('should read tags from body of file without duplication', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('callouts_nested_issue_2890_unlabelled');
        expect(tasksFile.tags).toEqual(['#task']);
    });
    // begin-snippet: iterate-over-multiple-SimulatedFiles
    it.each((0, MockDataHelpers_1.listPathAndData)([
        ...
        'yaml_tags_is_empty',
    ]))('should provide empty list if no tags in frontmatter: "%s"', (_path, testDataName) => {
    ...
    it('should be able to read all tags for any loaded SimulatedFile', () => {
        const file1 = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_with_one_value_on_new_line');
        expect((0, obsidian_1.getAllTags)(file1.cachedMetadata)).toEqual(['#single-value-new-line', '#task']);
        const file2 = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_with_one_value_on_single_line');
        expect((0, obsidian_1.getAllTags)(file2.cachedMetadata)).toEqual(['#single-value-single-line', '#task']);
        // Now see if we can again find the tags in file1
        expect((0, obsidian_1.getAllTags)(file1.cachedMetadata)).toEqual(['#single-value-new-line', '#task']);
    });
    it('should be able to read frontmatter tags for any loaded SimulatedFile', () => {
        const file1 = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_with_one_value_on_new_line');
        expect((0, obsidian_1.parseFrontMatterTags)(file1.cachedMetadata.frontmatter)).toEqual(['#single-value-new-line']);
        const file2 = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_tags_with_one_value_on_single_line');
        expect((0, obsidian_1.parseFrontMatterTags)(file2.cachedMetadata.frontmatter)).toEqual(['#single-value-single-line']);
        // Now see if we can again find the tags in file1
        expect((0, obsidian_1.parseFrontMatterTags)(file1.cachedMetadata.frontmatter)).toEqual(['#single-value-new-line']);
        const t = () => {
            (0, obsidian_1.parseFrontMatterTags)(file1.frontmatter);
        };
        expect(t).toThrow(Error);
        expect(t).toThrowError('FrontMatterCache not found in any loaded SimulatedFile. Did you supply TasksFile.frontmatter instead of TasksFile.cachedMetadata.frontmatter?');
    });
    it('should be able to call getFirstLinkpathDest() for any loaded SimulatedFile', () => {
        function loadMockDataAndResolveFirstLink(testDataName, expectedLinkSource) {
            const file = (0, MockDataHelpers_1.getTasksFileFromMockData)(testDataName);
            const link = file.cachedMetadata.links[0];
            expect(link.original).toMatchInlineSnapshot(expectedLinkSource);
            const markdownPath = MockDataLoader_1.MockDataLoader.markdownPath(testDataName);
            const firstLinkpathDest = (0, obsidian_1.getFirstLinkpathDest)(link, markdownPath);
        ...
        expect((0, obsidian_1.getFirstLinkpathDest)(destination1.link, destination1.markdownPath)).toMatchInlineSnapshot('"Test Data/yaml_tags_is_empty.md"');
    });
});
describe('TasksFile - properties', () => {
    ...
    it('should ignore the case of an upper case property name', () => {
        const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)('yaml_capitalised_property_name');
...
describe('TasksFile - identicalTo', () => {
    ...
    it('should detect identical objects', () => {
        const lhs = (0, TasksFileHelpers_1.createTestTasksFile)(path, cachedMetadata);
        const rhs = (0, TasksFileHelpers_1.createTestTasksFile)(path, cachedMetadata);
        expect(lhs.identicalTo(rhs)).toEqual(true);
    });
    it('should check path', () => {
        const lhs = (0, TasksFileHelpers_1.createTestTasksFile)(path, cachedMetadata);
        const rhs = (0, TasksFileHelpers_1.createTestTasksFile)('somewhere else.md', cachedMetadata);
        expect(lhs.identicalTo(rhs)).toEqual(false);
    });
    it('should check cachedMetadata', () => {
        const lhs = (0, MockDataHelpers_1.getTasksFileFromMockData)('example_kanban');
        expect(lhs.identicalTo((0, MockDataHelpers_1.getTasksFileFromMockData)('example_kanban'))).toEqual(true);
        expect(lhs.identicalTo((0, MockDataHelpers_1.getTasksFileFromMockData)('jason_properties'))).toEqual(false);
    });
});
//# sourceMappingURL=TasksFile.test.js.map