...
describe('dependencies', () => {
    const testData = [
        ...
        [
            ...
            SampleTasks_1.SampleTasks.withAllRepresentativeDependencyFields(),
        ],
        [
            'task.dependsOn',
            [
    ...
    it.each(testData)('%s results', (_, groups, tasks) => {
        (0, VerifyFunctionFieldSamples_1.verifyFunctionFieldGrouperSamplesOnTasks)(groups, tasks);
    });
    it.each(testData)('%s docs', (_, groups, _tasks) => {
        (0, VerifyFunctionFieldSamples_1.verifyFunctionFieldGrouperSamplesForDocs)(groups);
    });
});
describe('dates', () => {
    const testData = [
...
describe('file properties', () => {
    const testData = [
        ...
        [
            ...
            SampleTasks_1.SampleTasks.withAllRootsPathsHeadings(),
        ],
        [
            'task.file.root',
            [
...
describe('obsidian properties', () => {
    const tasks = (0, SimulatedFile_1.readAllTasksFromAllSimulatedFiles)();
    const testData = [
        // ---------------------------------------------------------------------------------
        // PROPERTIES FIELDS
        // ---------------------------------------------------------------------------------
...
//# sourceMappingURL=CustomGroupingExamples.test.js.map