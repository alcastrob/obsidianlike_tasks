...
describe('dates', () => {
    const testData = [
        ...
        ['task.due.advanced', [], SampleTasks_1.SampleTasks.withAllRepresentativeDueDates()],
        [
            'task.happens',
            [
                [
    ...
    it.each(testData)('%s results', (_, groups, tasks) => {
        (0, VerifyFunctionFieldSamples_1.verifyFunctionFieldSortSamplesOnTasks)(groups, tasks);
    });
...
describe('other properties', () => {
    const pseudoCustomPriorityEmojis = (0, TestHelpers_1.fromLines)({
        lines: [
            '- [ ] 🟦 pseudo low priority',
    ...
    const testData = [
        ...
        [
            ...
            SampleTasks_1.SampleTasks.withAllRecurrences(),
        ],
        [
            'task.recurrenceRule',
    ...
    return 999;`,
            ...
            SampleTasks_1.SampleTasks.withAllRepresentativeDescriptions().concat(SampleTasks_1.SampleTasks.withRepresentativeTags().concat(pseudoCustomPriorityEmojis)),
        ],
        [
        ...
        ['task.tags.advanced', [], SampleTasks_1.SampleTasks.withRepresentativeTags()],
        [
...
//# sourceMappingURL=CustomSortingExamples.test.js.map