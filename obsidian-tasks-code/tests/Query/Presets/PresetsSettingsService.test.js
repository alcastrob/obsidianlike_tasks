...
const PresetsSettingsService_1 = require("../../../src/Query/Presets/PresetsSettingsService");
function expectToBeValid(result) {
    expect(result.isValid).toBe(true);
    expect(result.errorMessage).toBe(null);
}
function expectToGiveError(result, errorMessage) {
...
describe('PresetsSettingsService', () => {
    ...
    let testPresets;
    beforeEach(() => {
        service = new PresetsSettingsService_1.PresetsSettingsService();
        testPresets = {
            key1: 'value1',
            key2: 'value2',
        };
...
//# sourceMappingURL=PresetsSettingsService.test.js.map