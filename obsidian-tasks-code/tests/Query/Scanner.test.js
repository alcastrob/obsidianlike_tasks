...
describe('continue_lines', () => {
    it('keeps non-continued text the same', () => {
        ...
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual(text);
    });
    it('removes backslashed newlines', () => {
        ...
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual('line1 continued');
    });
    it('only consumes one backslash', () => {
        ...
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual([
            // force linebreak
            String.raw `line1 ${bs}`,
            'line2',
        ].join('\n'));
    ...
    it('compresses surrounding spaces', () => {
        ...
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual(String.raw `line1 continued`);
    });
    ...
    it('should combine together over multiple lines', () => {
        ...
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual('description includes one two three four five six');
    });
    it('should preserve last instruction in query that ends in a continuation line = #3137', () => {
        const text = 'due today \\';
        expect((0, Scanner_1.continueLinesFlattened)(text)).toEqual('due today');
    });
...
-------------------------------------
${(0, Scanner_1.continueLines)(querySource)
            .map((statement) => `
...
describe('scan', () => {
    it('works on an easy case', () => {
        ...
        expect((0, Scanner_1.splitSourceHonouringLineContinuations)(text)).toEqual(['not done', 'due this week']);
    });
    ...
    it('supports line continuation', () => {
        ...
        expect((0, Scanner_1.splitSourceHonouringLineContinuations)(text)).toEqual(['( property1 ) AND (property2)']);
    });
    it('drops empty lines', () => {
        ...
        expect((0, Scanner_1.splitSourceHonouringLineContinuations)(text)).toEqual(['line1', 'line2', 'line3']);
    });
...
-------------------------------------
${(0, Scanner_1.splitSourceHonouringLineContinuations)(querySource).join('\n')}
-------------------------------------
`;
        (0, JestApprovals_1.verify)(output);
    });
