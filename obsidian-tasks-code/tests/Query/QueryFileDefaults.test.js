...
function generateQueryFileDefaultsSource(testDataName) {
    const tasksFile = (0, MockDataHelpers_1.getTasksFileFromMockData)(testDataName);
    return new QueryFileDefaults_1.QueryFileDefaults().source(tasksFile);
}
describe('QueryFileDefaults', () => {
    it('should treat the TasksFile as optional', () => {
        expect(new QueryFileDefaults_1.QueryFileDefaults().source(undefined)).toEqual('');
    });
    ...
    it('should give the property names in original order', () => {
        const names = new QueryFileDefaults_1.QueryFileDefaults().allPropertyNames();
    ...
    it('should give the property names in sorted order', () => {
        const names = new QueryFileDefaults_1.QueryFileDefaults().allPropertyNamesSorted();
        expect(names).toMatchInlineSnapshot(`
            [
              "TQ_explain",
              "TQ_extra_instructions",
    ...
    it('should provide a known property type', () => {
        expect(new QueryFileDefaults_1.QueryFileDefaults().propertyType('TQ_show_tree')).toEqual('checkbox');
    });
    it('should provide an unknown property type as undefined', () => {
        expect(new QueryFileDefaults_1.QueryFileDefaults().propertyType('TQ_any_old_property')).toBeUndefined();
    });
...
//# sourceMappingURL=QueryFileDefaults.test.js.map