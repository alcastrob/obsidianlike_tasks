...
describe('should report regular expression errors to user ', () => {
    it('should report mismatched parenthesis', () => {
        ...
        const filterOrError = new DescriptionField_1.DescriptionField().createFilterOrErrorMessage(instruction);
        expect(filterOrError.error).toEqual(String.raw `Error: Parsing regular expression.
...
describe('explains regular sub-string searches', () => {
    it('should explain simple string search', () => {
        ...
        const field = new DescriptionField_1.DescriptionField().createFilterOrErrorMessage(instruction);
    ...
    it('should explain simple string search, preserving instruction case', () => {
        const field = new DescriptionField_1.DescriptionField().createFilterOrErrorMessage('description INCLUDES hello');
        expect(field).toHaveExplanation('description INCLUDES hello');
    });
});
...
`;
        ...
        // Assert
        (0, JestApprovals_1.verify)(query.explainQuery() + `\nError: ${query.error ?? 'None'}`);
    });
});
