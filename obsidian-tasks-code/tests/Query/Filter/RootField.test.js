...
describe('root', () => {
    it('should provide access to root folder name with trailing slash', () => {
        const field = new RootField_1.RootField();
        const line = '- [ ] do';
        expect(field.value((0, TestHelpers_1.fromLine)({ line: line }))).toStrictEqual('/');
        expect(field.value((0, TestHelpers_1.fromLine)({ line: line, path: 'outside/inside/A.md' }))).toStrictEqual('outside/');
        expect(field.value((0, TestHelpers_1.fromLine)({ line: line, path: 'a_b/_c_d_/B.md' }))).toStrictEqual('a_b/');
        expect(field.value((0, TestHelpers_1.fromLine)({ line: line, path: '/root/SeArch_Text/search_text.md' }))).toStrictEqual('root/');
    });
});
describe('root', () => {
    ...
    it('filter by root (includes)', () => {
        // Arrange
        const filter = new RootField_1.RootField().createFilterOrErrorMessage('root includes search_text');
        // Assert
...
describe('grouping by root', () => {
    it('supports grouping methods correctly', () => {
        expect(new RootField_1.RootField()).toSupportGroupingWithProperty('root');
    });
    it.each([
        ['- [ ] a', 'a/b/c.md', ['a/']],
        ...
        // Arrange
        const grouper = new RootField_1.RootField().createNormalGrouper();
        // Assert
...
//# sourceMappingURL=RootField.test.js.map