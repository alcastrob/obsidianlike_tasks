...
function testTaskFilterForTaskWithDueDate(filter, dueDate, expected) {
    const builder = new TaskBuilder_1.TaskBuilder();
    (0, FilterTestHelpers_1.testFilter)(filter, builder.dueDate(dueDate), expected);
}
describe('due date', () => {
    afterAll(() => {
        jest.useRealTimers();
    ...
    it('by due date (before)', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due before 2022-04-20');
        // Act, Assert
    ...
    it('by due date (on or before) should match the given date and all earlier dates', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or before 2023-08-01');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date (on or after) should match the given date and all later dates', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or after 2022-02-01');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date - before absolute range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due before 2022-04-20 2022-04-24');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date - on or before absolute range should match the date range and all earlier dates', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or before 2021-07-10 2021-10-04');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date - on absolute range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on 2022-04-20 2022-04-24');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date - on or after absolute range should match the date range and all later dates', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or after 2023-03-10 2023-04-01');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('by due date - after absolute range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due after 2022-04-20 2022-04-24');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', false);
    ...
    it('by due date - in absolute range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due in 2022-04-20 2022-04-24');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', true);
    ...
    it('by due date - absolute range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2022-04-20 2022-04-24');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', true);
    ...
    it('due in two weeks', () => {
        ...
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due in two weeks');
...
describe('due date (specific ranges)', () => {
    it('due in specific range (year)', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2022');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('due in specific range (quarter)', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2017-Q3');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('due in specific range (month)', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2020-03');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('due in specific range (week)', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2023-W09');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
...
describe('due date (error & corner cases)', () => {
    it('invalid due date', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due date is invalid');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    it('date range with both dates invalid', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due date 2023-13-01 2022-01-78');
        // Act, Assert
    ...
    it('date range with first date invalid treated as a date', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due date 2023-13-01 2022-01-07');
        // Act, Assert
    ...
    it('date range with second date invalid treated as a date', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due date 2023-12-01 2022-01-78');
        // Act, Assert
        // Currently the invalid date is ignored and date range is treated as a date
    ...
    it('date range with invalid relative date range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due thees week');
        // Act, Assert
        expect(filter.filterFunction).toBeUndefined();
        expect(filter.error).toBeDefined();
    });
    it('before reversed range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due before 2022-04-24 2022-04-20');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', true);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', false);
    ...
    it('in reversed range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2022-04-24 2022-04-20');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', true);
    ...
    it('after reversed range', () => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due after 2022-04-24 2022-04-20');
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-19', false);
        testTaskFilterForTaskWithDueDate(filter, '2022-04-20', false);
...
describe('due date before relative date range (Today is 2022-05-25)', () => {
    ...
    ])('due before %s: task with due date on %s is included; %s, %s, %s are not', (range, beforeRange, rangeStart, rangeEnd, afterRange) => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due before ${range}`);
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    ])('should explain before relative date range (%s)', (range, date) => {
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due before this ${range}`);
...
describe('due date in relative date range (Today is 2023-02-28)', () => {
    ...
    ])('due (in|on|) %s: task with due date %s not included, %s and %s included, %s not included again', (range, beforeRange, rangeStart, rangeEnd, afterRange) => {
        // Arrange
        const filterOn = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due on ${range}`);
        const filterIn = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due in ${range}`);
        const filterEmpty = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due ${range}`);
        // Act, Assert
    ...
    ])('should explain in a relative date range (%s)', (range, dateStart, dateEnd) => {
        const filterOn = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due on this ${range}`);
        const filterIn = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due in this ${range}`);
        const filterEmpty = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due this ${range}`);
...
describe('due date after relative date range (Today is 2021-11-01)', () => {
    ...
    ])('due after %s: task with due date %s, %s, %s are not included, %s is', (range, beforeRange, rangeStart, rangeEnd, afterRange) => {
        // Arrange
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due after ${range}`);
        // Act, Assert
        testTaskFilterForTaskWithDueDate(filter, null, false);
    ...
    ])('should explain after relative date range (%s)', (range, date) => {
        const filter = new DueDateField_1.DueDateField().createFilterOrErrorMessage(`due after this ${range}`);
        expect(filter).toHaveExplanation(`due date is after ${date}`);
    });
});
describe('explain due date queries', () => {
    it('should explain explicit date', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due before 2023-01-02');
    ...
    it('implicit "on" gets added to explanation', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2023-01-02');
        expect(filterOrMessage).toHaveExplanation('due date is on 2023-01-02 (Monday 2nd January 2023)');
    });
    it('should explain date range', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due 2022-11-25 2023-01-17');
        expect(filterOrMessage).toHaveExplanation(`due date is between:
  ...
  2023-01-17 (Tuesday 17th January 2023) inclusive`);
    ...
    it('should explain "on or before" with a single date', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or before 2023-08-08');
    ...
    it('should explain "on or after" with a single date', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due on or after 2023-07-29');
    ...
    it('should explain "in or before" with an absolute date range', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due in or before 2023-10-20 2023-11-01');
    ...
    it('should explain "in or after" with an absolute date range', () => {
        const filterOrMessage = new DueDateField_1.DueDateField().createFilterOrErrorMessage('due in or after 2023-10-20 2023-11-01');
...
describe('sorting by due', () => {
    const date1 = new TaskBuilder_1.TaskBuilder().dueDate('2021-01-12').build();
    const date2 = new TaskBuilder_1.TaskBuilder().dueDate('2022-12-23').build();
    it('supports Field sorting methods correctly', () => {
        const field = new DueDateField_1.DueDateField();
        expect(field.supportsSorting()).toEqual(true);
    });
    it('sort by due', () => {
        // Arrange
        const sorter = new DueDateField_1.DueDateField().createNormalSorter();
        // Assert
    ...
    it('sort by due reverse', () => {
        // Arrange
        const sorter = new DueDateField_1.DueDateField().createReverseSorter();
        // Assert
...
describe('due date', () => {
    ...
    it('approval tests', () => {
        ...
        const table = new MarkdownTable_1.MarkdownTable(['date / keyword'].concat(dates));
        keywords.forEach((keyword) => {
            const newRow = [keyword];
            dates.forEach((date) => {
                const query = new Query_1.Query(`due ${keyword}${date}`);
        ...
        (0, VerifyMarkdown_1.verifyMarkdown)(table.markdown);
    });
});
describe('grouping by due date', () => {
    it('supports Field grouping methods correctly', () => {
        expect(new DueDateField_1.DueDateField()).toSupportGroupingWithProperty('due');
    });
    it('group by due date', () => {
        // Arrange
        const grouper = new DueDateField_1.DueDateField().createNormalGrouper();
        const taskWithDate = new TaskBuilder_1.TaskBuilder().dueDate('1970-01-01').build();
...
//# sourceMappingURL=DueDateField.test.js.map