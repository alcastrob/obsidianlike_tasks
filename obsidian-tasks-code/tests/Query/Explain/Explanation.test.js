...
describe('Explain', () => {
    it('Explains single filter', () => {
        ...
        const explanation = new Explanation_1.Explanation(description);
    ...
    it('Explains an AND boolean combination', () => {
        const children = [new Explanation_1.Explanation('x includes A'), new Explanation_1.Explanation('x includes B')];
        const explanation = Explanation_1.Explanation.booleanAnd(children);
  ...
  x includes B`;
    ...
    it('Explains an OR boolean combination', () => {
        const children = [new Explanation_1.Explanation('x includes A'), new Explanation_1.Explanation('x includes B')];
        const explanation = Explanation_1.Explanation.booleanOr(children);
    ...
    it('Explains a NOT boolean combination', () => {
        const children = [new Explanation_1.Explanation('x includes A'), new Explanation_1.Explanation('x includes B')];
        const explanation = Explanation_1.Explanation.booleanNot(children);
    ...
    it('Explains an XOR boolean combination', () => {
        const children = [new Explanation_1.Explanation('x includes A'), new Explanation_1.Explanation('x includes B')];
        const explanation = Explanation_1.Explanation.booleanXor(children);
    ...
    it('Explains a nested boolean combination', () => {
        const not = Explanation_1.Explanation.booleanOr([new Explanation_1.Explanation('x1 includes A'), new Explanation_1.Explanation('x1 includes B')]);
        const or = Explanation_1.Explanation.booleanOr([new Explanation_1.Explanation('x2 includes C'), new Explanation_1.Explanation('x2 includes D')]);
        const and = Explanation_1.Explanation.booleanAnd([not, or]);
        const expected = `AND (All of):
  OR (At least one of):
    x1 includes A
    x1 includes B
  OR (At least one of):
    ...
    it('Explains a nested non-boolean combination (Indent only depending on children)', () => {
        ...
        const bottomLevelExplanation = new Explanation_1.Explanation('or foobar sauce');
        const nestedExplanations = [
            new Explanation_1.Explanation('you eat apple sauce', [bottomLevelExplanation]),
            new Explanation_1.Explanation('you enjoy bar'),
            new Explanation_1.Explanation('you love foo'),
        ];
        const explanation = new Explanation_1.Explanation(firstLine, nestedExplanations);
