...
function setDependencies(task, _allTasks, dependsOn, _dependedUpon) {
    ...
    return new Task_1.Task({ ...task, dependsOn: newDependsOn });
}
function createTasks(markdown) {
    return (0, TestHelpers_1.createTasksFromMarkdown)(markdown, 'stuff.md', 'Heading');
}
...
//# sourceMappingURL=SetTaskDependenciesInstruction.test.js.map