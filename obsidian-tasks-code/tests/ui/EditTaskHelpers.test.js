...
const EditTaskHelpers_1 = require("../../src/ui/EditTaskHelpers");
describe('labelContentWithAccessKey() tests', () => {
    it.each([
        ...
        expect((0, EditTaskHelpers_1.labelContentWithAccessKey)(labelText, accessKey)).toEqual(labelContent);
    });
});
//# sourceMappingURL=EditTaskHelpers.test.js.map